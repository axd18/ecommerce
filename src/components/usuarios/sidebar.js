...
<div class="flex flex-wrap bg-gray-100 w-full h-screen">
    <div class="w-3/12 bg-white rounded p-3 shadow-lg">
        <div class="flex items-center space-x-4 p-2 mb-5">
            <img class="h-12 rounded-full" src="http://www.gravatar.com/avatar/2acfb745ecf9d4dccb3364752d17f65f?s=260&d=mp" alt="James Bhatta"></img>
            <div>
                <h4 class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">Pepe Argento</h4>
                <span class="text-sm tracking-wide flex items-center space-x-1">
                    ...
                    </svg><span class="text-gray-600">Verificada</span>
                </span>
            </div>
        </div>
